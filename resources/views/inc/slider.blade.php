...
<div id="carouselIndicators" class="carousel slide " data-ride="carousel">
  ...
  <ol class="carousel-indicators">
    ...
    @for($i = 0; $i < count($banners); $i++) <li data-target="#carouselIndicators" data-slide-to="{{$i}}"
      class=" {{($i == 0)?'active':'' }}">
      </li>
      @endfor
  </ol>
    ...
    <div class="carousel-item {{ ($i == 0)?'active':'' }}">
      ...
      <div class="hero carousel-caption d-none d-block">
        ...
        <a class="d-none d-md-block" href="{{ $banner->link }}">
          <button class="btn btn-outline-success btn-lg rounded-0 font-weight-bold" role="button">Get a FREE quotation
            today!</button>
        </a>
      </div>
    </div>
  ...
  <a class="carousel-control-prev" href="#carouselIndicators" role="button" data-slide="prev">
    <i class="fas fa-chevron-left fa-10x"></i>
    {{-- <span class="carousel-control-prev-icon" aria-hidden="true"></span> --}}
    <span class="sr-only">Previous</span>
  </a>
  <a class="carousel-control-next" href="#carouselIndicators" role="button" data-slide="next">
    {{-- <span class="carousel-control-next-icon" aria-hidden="true"></span> --}}
    <i class="fas fa-chevron-right fa-10x"></i>
